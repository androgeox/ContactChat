...
@EnableJpaRepositories(basePackages = {"com.georgiy.contactchat.repository"})
public class DataConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[]{"com.georgiy.contactchat"});
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManager.setPackagesToScan("com.georgiy.contactchat");
